...
router.get("/top-borrow", verifyToken, async(req,res)=>{
    try {
        ...
        SELECT b.book_name, COUNT(i.book_id) AS borrow_time, COUNT(DISTINCT i.issuance_member) AS member_borrow 
        FROM "Book" b LEFT JOIN "Issuance" i ON b.book_id=i.book_id GROUP BY b.book_name ORDER BY borrow_time 
        DESC LIMIT 10;`
