...
const Status: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchBorrowDetails = async () => {
            try {
                const response = await fetch("http://localhost:6003/lib/borrow/details", {
    ...
    const fetchAdminData = async () => {
        ...
        try {
            const response = await fetch("http://localhost:6003/lib/admin/borrow/all", {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const updateStatus = async (issuance_id: number, status: string) => {
        try {
            await fetch(`http://localhost:6003/lib/admin/borrow/update/${issuance_id}`, {
                method: "PUT",
                headers: {
